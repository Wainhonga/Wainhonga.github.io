...
! function(e, t, n) {
    ...
    function m(e, n, r, s) {
        var o, i, l, u, f = "modernizr",
            ...
            c = p();
        if (parseInt(r, 10))
            for (; r--;) l = a("div"), l.id = s ? s[r] : f + (r + 1), d.appendChild(l);
    ...
    function g(e, t, s, o) {
        ...
        for (p = e.length, c = 0; p > c; c++)
            if (m = e[c], g = L.style[m], l(m, "-") && (m = i(m)), L.style[m] !== n) {
    ...
    Modernizr.addTest("backgroundblendmode", O("backgroundBlendMode", "text")), Modernizr.addTest("objectfit", !!O("objectFit"), {
        aliases: ["object-fit"]
    }), S.testAllProps = h, Modernizr.addTest("backgroundcliptext", function() {

...
function(e, t, i, n) {
        ...
        var a = "liquidSubmenu",
            ...
            o = function() {
                ...
                return _createClass(n, [{
                    ...
                    key: "slideToggle",
                    value: function e(t, i, n, a, s, o) {
                        i.closest("li").siblings().find(".nav-item-children, .children").stop().slideUp(this.options.animationSpeed), i.stop().slideToggle(this.options.animationSpeed), n && (o.children(".megamenu-hover-bg").css("background-color", s), this.$mainHeader.removeClass("megamenu-scheme-dark megamenu-scheme-light"), this.$mainHeader.toggleClass("megamenu-item-active megamenu-scheme-".concat(a)))
                    }
                }, {
                    key: "slideDown",
                    value: function e(t, i, n, a, s, o) {
        ...
        var a = "liquidCustomAnimations",
            ...
            o = function() {
                ...
                return _createClass(n, [{
                    ...
                    key: "_onWindowResize",
                    value: function e() {
                        "inview" !== this.options.triggerHandler && (this.animationTarget = this._getAnimationTargets(), this._initValues(), this._eventHandlers()), this.$element.find("[data-text-rotator]").length && this.$element.find("[data-text-rotator]").data("plugin_liquidTextRotator") && (this.$element.find("[data-text-rotator]").data("plugin_liquidTextRotator", ""), this.$element.find(".txt-rotate-keywords").addClass("ws-nowrap").css("width", ""), anime.remove(this.$element.get(0)), anime.remove(this.$element.find(".keyword").get()), this.$element.find(".keyword").removeClass("active is-next will-change").css({
                            opacity: "",
                            transform: ""
                ...
                return _createClass(i, [{
                    ...
                    value: function i(n) {
                        var a = e(n.target),
                            ...
                            o = e(t);
                        this.$element.offset().top <= o.scrollTop() - 15 && e("html, body").animate({
    ...
    function(e, t, i, n) {
        function a(t, i) {
            this.element = t, this.$element = e(t), _typeof(i) !== _typeof(n) && null !== i && _typeof(i.color) !== _typeof(n) && null !== i.color && (i.customColorApplied = !0), this.options = e.extend({}, o, i), this._defaults = o, this._name = s, this.init()
        }
        ...
        a.prototype = {
            ...
            addColors: function t(a) {
                var s = _typeof(a.el) !== _typeof(n) ? e(a.el) : a.find(".iconbox-icon-container svg"),
                    ...
                    d = null;
                n === u[1] && (u[1] = u[0]), d = '<defs xmlns="http://www.w3.org/2000/svg"><linearGradient gradientUnits="userSpaceOnUse" id="grad' + r + '" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="' + u[0] + '" /><stop offset="100%" stop-color="' + u[1] + '" /></linearGradient></defs>';
                var h = (new DOMParser).parseFromString(d, "text/xml");
                return s.prepend(h.documentElement), _typeof(n) !== _typeof(l) && null !== l && (l = l.split(":"), n === l[1] && (l[1] = l[0]), c.innerHTML = "#" + this.$element.attr("id") + ":hover .iconbox-icon-container defs stop:first-child{stop-color:" + l[0] + ";}#" + this.$element.attr("id") + ":hover .iconbox-icon-container defs stop:last-child{stop-color:" + l[1] + ";}", s.prepend(c)), o.customColorApplied && s.find("path, rect, ellipse, circle, polygon, polyline, line").attr({
                    stroke: "url(#grad" + r + ")",
                    fill: "none"
    ...
    function(e, t, i, n) {
        var a = "liquidMasonry",
            ...
            o = function() {
                function t(i, n) {
                    _classCallCheck(this, t), this.element = i, this.$element = e(i), this.options = e.extend({}, s, n), this._defaults = s, this._name = a, this.onFilterChange = null, this.onLayoutComplete = null, this.init()
                }
                return _createClass(t, [{
                    key: "init",
                    value: function e() {
                    ...
                    value: function t() {
                        var i = this,
                            n, a = i.options.filtersID;
                        a && (i.$element.isotope({
                            filter: e(".active", e(a)).attr("data-filter")
                        }), e(a).on("click", "li", (function() {
                            var t = e(this),
                                n = t.attr("data-filter");
                            t.addClass("active").siblings().removeClass("active"), i.$element.isotope({
                                filter: n
                            })
                        })))
                    }
    ...
    function(e, t, i, n) {
        var a = "liquidShrinkBorders",
            ...
            o = function() {
                function i(t, n) {
                    _classCallCheck(this, i), this.element = t, this.$element = e(t), this.options = e.extend({}, s, n), this._defaults = s, this._name = a, this.controller = new ScrollMagic.Controller, this.$parentRow = this.$element.closest(".vc_row"),
                        this.$contents = this.$parentRow.children(".container").length ? this.$parentRow.children(".container") : this.$parentRow.children(".ld-container"), this.contentsHeight = this.$contents.height(), this.$animatables = this.$element.children(), this.init()
                }
                return _createClass(i, [{
                    key: "init",
                    value: function e() {
    ...
    function(e, t, i, n) {
        var a = "liquidBackToTop",
            ...
            o = function() {
                function t(i, n) {
                    _classCallCheck(this, t), this.element = i, this.$element = e(i), this.$pageContentElement = e("#content"),
                        this.options = e.extend({}, s, n), this._defaults = s, this._name = a, this.init()
                }
                return _createClass(t, [{
                    key: "init",
                    value: function e() {
                    ...
                    value: function e() {
                        ...
                        i.is(".liquid-portfolio") && (i = i.children(".pf-single-contents").children(".vc_row").first()), new IntersectionObserver((function(e) {
                            e.forEach((function(e) {
                                var i = e.boundingClientRect,
                                    n = e.rootBounds;
